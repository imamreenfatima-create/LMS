      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F8FAFC]">
        <div className="w-full max-w-md hg-fade">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 mt-2 text-sm">Use your Admin ID (AD###) or Employee Code (1001–1500).</p>
          </div>
          <form onSubmit={submit} className="space-y-5">
            ...
            <div className="border-t border-slate-200 pt-5 text-xs text-slate-500 space-y-2">
              ...
              <div className="font-mono space-y-1">
                <div><span className="text-slate-900 font-semibold">AD001</span> · Welcome@123 (Super Admin)</div>
